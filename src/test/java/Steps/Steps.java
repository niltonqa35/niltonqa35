...
public class Steps {
	...
	public void preencher_o_formulario_de_abertura_de_conta() {
       m.preencher(e.getCampoNome(), "Nilton");
	   m.preencher(e.getCampoTelefone(), "75911111111");
